...
double newton_method( std::function<double(double)> f, std::function<double(double)> d, double target, double initialGuess, const double tolerance, const int maxIterations);